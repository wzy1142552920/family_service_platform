...
public class TestGenerator {
    ...
    public void testGenerator() {
        ...
        globalConfig.setAuthor("luckydog")
                .setOutputDir("D:\\Project\\03_Java\\family_service_platform\\src\\main\\java")//设置输出路径
        ...
        dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver").setUrl("jdbc:mysql://localhost:3306/family_service_platform?serverTimezone=UTC")
                .setUsername("root").setPassword("1234");
        ...
        packageConfig.setParent("com.luckydog").setMapper("mapper")
